...
type MetadataServiceClient interface {
	...
	PutMetadata(ctx context.Context, in *PutMetadataRequest, opts ...grpc.CallOption) (*PutMetadaResponse, error)
}
...
func (c *metadataServiceClient) PutMetadata(ctx context.Context, in *PutMetadataRequest, opts ...grpc.CallOption) (*PutMetadaResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PutMetadaResponse)
...
type MetadataServiceServer interface {
	...
	PutMetadata(context.Context, *PutMetadataRequest) (*PutMetadaResponse, error)
...
func (UnimplementedMetadataServiceServer) PutMetadata(context.Context, *PutMetadataRequest) (*PutMetadaResponse, error) {
